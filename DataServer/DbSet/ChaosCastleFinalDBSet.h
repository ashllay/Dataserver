...
public:
	...
	int CopyUBFAccountUser(char *szAccountID, char *szName, __int16 GameServerCode, char *subResult); // idb
	int CopyUBFAccountUserPromotionMode(char *szAccountID, char *szName, __int16 GameServerCode, char *subResult); // idb
