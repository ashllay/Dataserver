...
BOOL CMuRummyDBSet::DBSelectMuRummyCardInfo(char* szAccountID, char* szName, _tagMuRummyCardInfoDS* stOutMuRummyCardInfoDS, WORD* wOutScore, BYTE* btGameType, BYTE* btSpecialCardDeckCnt)
{
	int result;
	__int16 sqlReturn;
	CString QueryStr;
...
BOOL CMuRummyDBSet::DBUpdateMuRummyInfo(char* szAccountID, char* szName, WORD wScore, _tagMuRummyCardUpdateDS* stCardUpdateDS, BYTE btGameType, BYTE btSpecialDeckCnt)
{
	int result;
	BYTE btStatus;
	BYTE btSeq;
...
BOOL CMuRummyDBSet::DBInsertMuRummyLog(char* szAccountID, char* szName, WORD wScore)
{
	int result;
	CString QueryStr;
