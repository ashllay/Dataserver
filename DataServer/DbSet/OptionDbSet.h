...
public:
	...
	BOOL Load(char* name, BYTE* KeyBuffer, BYTE& GO, BYTE& QK, BYTE& WK, BYTE& EK, BYTE& CW, BYTE& RK, int& QWERLevel, BYTE& EnableChangeMode, short& PlayGuideLv, BYTE& PlayGuideCheck);
	void Save(char* name, BYTE* KeyBuffer, BYTE GO, BYTE QK, BYTE WK, BYTE EK, BYTE CW, BYTE RK, int QWERLevel, BYTE EnableChangeMode, short PlayGuideLv, BYTE PlayGuideCheck);
